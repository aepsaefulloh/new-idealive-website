<template>
  <header
    class="sticky top-0 z-30 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 transition-colors duration-300">
    <div class="flex items-center justify-between px-6 py-4">
      ...
      <div class="flex items-center gap-3 sm:gap-4">
        ...
        <Dropdown>
          <template #trigger>
            <button
              class="flex items-center gap-3 pl-2 pr-1 py-1 rounded-full hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors border border-transparent hover:border-gray-200 dark:hover:border-gray-700">
              <div class="w-8 h-8 rounded-full bg-gradient-to-tr from-blue-500 to-purple-600 p-[2px]">
                <div class="w-full h-full rounded-full bg-white dark:bg-gray-900 flex items-center justify-center">
                  <span
                    class="text-xs font-bold bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">{{
                      userInitials }}</span>
                </div>
              </div>
          ...
          <template #content>
            <div class="py-1">
              ...
              <div class="p-1">
                <a href="#"
                  class="flex items-center  py-2 text-sm text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                  <UIicon name="i-heroicons-cog-6-tooth" class="w-4 h-4 mr-3 text-gray-400" />
                  Settings
                </a>
                <a href="#"
                  class="flex items-center  py-2 text-sm text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                  <UIicon name="i-heroicons-question-mark-circle" class="w-4 h-4 mr-3 text-gray-400" />
                  Help & Support
                </a>
              </div>
              ...
              <div class="p-1">
                <Button @click="handleLogout" variant="ghost" block
