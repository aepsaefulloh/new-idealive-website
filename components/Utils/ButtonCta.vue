<template>
  ...
  <NuxtLink ref="linkRef" :to="root" class="btn-main cursor-pointer" @click="handleClick" @mouseenter="handleMouseEnter"
...
const textTopRef = ref(null);
const textBottomRef = ref(null);
