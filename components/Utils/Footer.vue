  ...
  <div>
    <div class="container-xl px-desktop md:py-[2.646vw] py-[40px]">
      <div class="border-b border-[#2054FA] md:pb-10 pb-4">
        ...
        <div class="">
          <div
            class="flex md:flex-row flex-col md:mt-0 mt-[7.692vw] items-end md:justify-between md:gap-0 gap-[20.513vw]">
            <NuxtLink :to="contactInfo?.[0]?.map_url || '#'" target="_blank" rel="noopener noreferrer"
              class="md:w-[25vw] md:pt-[10.582vw] copy">{{ content.address }}</NuxtLink>
      ...
      <div class="md:pt-10 pt-4 flex justify-between items-end">
        <img src="/images/logo-idealive.svg" class="filter invert contrast-200 md:w-[8.995vw] w-[90px]"
          alt="Idealive Logo">
...
const content = computed(() => ({
  brandText: "Make your",
  brandText2: "brand ",
  copyright: `Copyright © ${currentDate} Idealive. PT Raksasa Sembilan Media All Rights Reserved.`,
